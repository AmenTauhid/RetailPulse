...
const NAV_ITEMS = [
  ...
  { href: "/forecasts", label: "Forecasts", icon: "M13 7h8m0 0v8m0-8l-8 8-4-4-6 6" },
  { href: "/anomalies", label: "Anomalies", icon: "M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-2.5L13.732 4c-.77-.833-1.964-.833-2.732 0L3.34 16.5c-.77.833.192 2.5 1.732 2.5z" },
  ...
  return (
    <aside className="fixed left-0 top-0 z-40 h-screen w-64 bg-gray-900 text-white">
      <div className="flex h-16 items-center gap-2 border-b border-gray-700 px-6">
        ...
        <span className="text-lg font-semibold">RetailPulse</span>
      </div>
      ...
      <div className="absolute bottom-0 w-full border-t border-gray-700 p-4">
        <p className="text-xs text-gray-500">RetailPulse v0.1.0</p>
        <p className="text-xs text-gray-500">AI-Powered Demand Intelligence</p>
      </div>
    </aside>
  );
}
