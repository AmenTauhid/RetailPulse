...
CATEGORIES = [
    ...
    Category(name="Patio Furniture", department="Living", is_seasonal=True, peak_season="summer"),
    Category(name="Hockey Equipment", department="Sports", is_seasonal=True, peak_season="fall"),
    Category(name="Camping Gear", department="Sports", is_seasonal=True, peak_season="summer"),
    Category(name="Christmas Decor", department="Living", is_seasonal=True, peak_season="winter"),
    Category(
